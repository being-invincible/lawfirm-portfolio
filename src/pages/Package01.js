...
const Package01 = () => {
  ...
  return (
    <div>
      ...
      >
        {i18n.language === 'عربي' ? (
          <div class="bg-metalic-grey/40 p-8 md:p-12 lg:px-16 lg:pb-24 lg:pt-36">
            <div class="text-right ltr:sm:text-left rtl:sm:text-right lg:mr-[50px]">
              ...
              <div className='w-full col-span-1 flex flex-row-reverse items-baseline lg:my-3 float-right'>
                <p className='pr-5 py-5 order-2 text-xl sm:text-3xl'>{t(`${"package"}.package01.currency`)}</p>
                <h1 className='font-semibold text-xl sm:text-3xl md:text-[100px]'>{t(`${"package"}.package01.price`)}</h1>
              </div>

              <h1 className='ml-10 mb-8 text-lg font-bold sm:text-xl md:text-3xl'>{t(`${"package"}.package01.title`)}</h1>
          ...
          <div class="bg-metalic-grey/40 p-8 md:p-12 lg:px-16 lg:pb-24 lg:pt-36">
            <div class="text-left ltr:sm:text-left rtl:sm:text-right">
              ...
              <div className='ml-5 col-span-1 flex flex-row items-baseline lg:p-3 lg:w-[18rem]'>
                <p className='pl-5 py-5 order-2 text-xl sm:text-3xl'>{t(`${"package"}.package01.currency`)}</p>
                <h1 className='font-semibold text-xl sm:text-3xl md:text-[100px]'>{t(`${"package"}.package01.price`)}</h1>
              </div>
      ...
      <section className='px-[100px] py-8 bg-olive'>
        {i18n.language === 'عربي' ? (
          <div>
            <p
            ...
            <div className='mt-10 mb-5'>
              <ul className='grid grid-cols-2 text-md gap-y-2 lg:gap-y-5 lg:gap-x-10'>
                {points01.map((s, i) =>
