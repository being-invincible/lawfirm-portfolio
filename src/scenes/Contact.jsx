...
const Contact = ({contact, contactContent, font}) => {
  ...
  return (
    <section id='contact' className={`md:justify-between md:items-center py-10 ${font}`}>
    ...
    <div className='mt-36 px-5 md:px-10 py-10 bg-metalic-grey w-full rounded-lg'>
        ...
        >
            <h2 className='text-mettalic-gold text-xl font-bold z-10 text-center uppercase tracking-[.25em]'>
                {contact}
            </h2>
            
            <p className='mt-5 mb-8 text-sm text-center font-medium'>
                {contactContent}
            </p>
    ...
    <h2 className='text-xl mt-10 font-bold z-10 text-center uppercase tracking-[.25em]'>
        Or
    </h2>
